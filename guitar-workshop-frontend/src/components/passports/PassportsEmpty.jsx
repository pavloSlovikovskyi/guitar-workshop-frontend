export default function PassportsEmpty({ onAdd }) {
  return (
    <div className="text-center py-20 bg-white p-12 border-2 border-black">
      ...
      <h3 className="text-2xl font-bold uppercase tracking-tight mb-4">Техпаспортів немає</h3>
      <p className="text-sm font-medium leading-tight text-black mb-8">Додайте перший паспорт для інструменту</p>
